...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className='text-stone-500 inline-flex text-centergap-2
      ...
      >Unleash your creativity wit AI.Turn your imagination into visual art in seconds - just type, and watch the amgic happen.</motion.p>

      <motion.button 
      onClick={onClickHandler}
       className='sm:text-lg text-white bg-black w-auto mt-8 pax-12 py-2.5 flex items-center gap-2 rounded-full'
